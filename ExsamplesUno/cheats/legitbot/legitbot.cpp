...
{
	static auto LineGoesThroughSmokeFn = (bool(*)(Vector vStartPos, Vector vEndPos))util::FindSignature(m_xor_str("client.dll"), m_xor_str("55 8B EC 83 EC 08 8B 15 ? ? ? ? 0F 57 C0"));
