...
int netg_cfg::get_offset(const char *tableName, const char *propName) 
{
...
int netg_cfg::get_prop(const char *tableName, const char *propName, RecvProp **prop) 
{
...
int netg_cfg::get_prop(RecvTable *recvTable, const char *propName, RecvProp **prop) 
{
	int extrOffs = 0;
...
RecvTable *netg_cfg::get_table(const char *tableName) 
{
	if (tables.empty())
		return 0;
