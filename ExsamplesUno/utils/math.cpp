...
namespace math
{
	float normalize_angles(Vector& angles)
	{
	...
	float random_float(float min, float max) {
		...
		static RandomFloat_t m_RandomFloat = (RandomFloat_t)GetProcAddress(GetModuleHandle(m_xor_str("vstdlib.dll")), m_xor_str("RandomFloat"));
		return m_RandomFloat(min, max);
	}
	//--------------------------------------------------------------------------------
	int random_int(int min, int max) {
		typedef int(*RandomInt_t)(int, int);
		static RandomInt_t m_RandomInt = (RandomInt_t)GetProcAddress(GetModuleHandle(m_xor_str("vstdlib.dll")), m_xor_str("RandomInt"));
		return m_RandomInt(min, max);
	}
	//--------------------------------------------------------------------------------
	void random_seed(int seed) {
		typedef void(*RandomSeed_t)(int);
		static RandomSeed_t m_RandomSeed = (RandomSeed_t)GetProcAddress(GetModuleHandle(m_xor_str("vstdlib.dll")), m_xor_str("RandomSeed"));
